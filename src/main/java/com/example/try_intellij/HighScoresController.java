...
import java.io.*;
import java.util.*;
import static com.example.try_intellij.Constants.DELIMITER;
...
public class HighScoresController {
    ...
    HighScore[] fillHighScores() {
        ...
        int index = 0;
        try {
            Scanner scanner = new Scanner(new File("src/main/resources/com/example/try_intellij/data/scores.txt"));
    ...
    @FXML void onClearDataButtonClick() {
        try {
            FileOutputStream writer = new FileOutputStream("src/main/resources/com/example/try_intellij/data/scores.txt");
